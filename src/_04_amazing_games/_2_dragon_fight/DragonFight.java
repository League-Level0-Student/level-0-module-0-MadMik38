...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
	String Input = JOptionPane.showInputDialog("Do you want to do a yell attack or kick attack?");
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null, "You have beed defeated by the dragon and you have no treasure. :(");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "You have defeated the dragon and got tons of gold! :)");
		System.exit(0);   //This code ends the program
	}
